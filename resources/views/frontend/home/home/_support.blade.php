...
<section class=" padding-tb page-header" style="background-image: url({{ asset('frontend/assets/images/support/bg-image.jpeg') }}); background-size: cover;">
    <div class="page-header-area linear-style support-section" style="background-size: cover; height: 100%;">
        <div class="container">
            <div class="section-header style-2 mt-3 pt-3" data-aos="fade-up" data-aos-duration="700">
